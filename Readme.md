What we built at Toledo Labs with Toledo1 is a prototype design for an AI web browser, where the URL points to LLM inference—a direct chat line to any LLM on the public internet, private cloud or local desktop. A paradigm shift in web search.
